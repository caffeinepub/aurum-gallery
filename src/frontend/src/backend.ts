...
import type { Moment as _Moment, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createMoment(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string | null, arg6: string | null): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createMoment(arg0, arg1, arg2, arg3, arg4, to_candid_opt_n10(this._uploadFile, this._downloadFile, arg5), to_candid_opt_n10(this._uploadFile, this._downloadFile, arg6));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteMoment(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllMoments(): Promise<Array<Moment>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllMoments();
    ...
    async getMoment(arg0: bigint): Promise<Moment | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getMoment(arg0);
    ...
    async getMomentCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getMomentCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateMoment(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string | null, arg6: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateMoment(arg0, arg1, arg2, arg3, arg4, to_candid_opt_n10(this._uploadFile, this._downloadFile, arg5), to_candid_opt_n10(this._uploadFile, this._downloadFile, arg6));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_Moment_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Moment): Moment {
...
function from_candid_opt_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Moment]): Moment | null {
    return value.length === 0 ? null : from_candid_Moment_n12(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        audioId: record_opt_to_undefined(from_candid_opt_n14(_uploadFile, _downloadFile, value.audioId)),
        caption: value.caption,
        imageId: value.imageId,
        uploadedBy: value.uploadedBy,
        videoId: record_opt_to_undefined(from_candid_opt_n14(_uploadFile, _downloadFile, value.videoId))
    };
}
...
function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Moment>): Array<Moment> {
    return value.map((x)=>from_candid_Moment_n12(_uploadFile, _downloadFile, x));
}
